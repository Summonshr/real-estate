<div class="bg-gray-100 max-w-5xl rounded-sm" id="dropzone">
    <h3 class="bg-blue-900 text-gray-300 p-2 px-4 flex justify-between">Uploads</h3>
            ...
            <div class="flex flex-wrap">
                ...
                <div wire:key="{{$media->id}}" class="w-1/5 p-2 relative">
                    <div class="absolute top-0 right-0 mr-2 mt-2" x-data="{open:false}">
                        <button class="bg-blue-900 px-2 float-right text-blue-100" x-on:click="open=!open">...</button>
                        <div x-show="open" class="bg-blue-900 mt-6">
                            <ul>
                                ...
                                @endif
                                <li wire:click="deleteMedia({{$media->id}})" class="px-2 py-1 text-red-100 border-red-800 border-b bg-red-800 cursor-pointer hover:bg-red-800">Delete</li>
                            </ul>
                        </div>
                    </div>
