<div class="flex flex-wrap p-2">
    ...
    <div class="w-1/4 p-2 relative">
        <div wire:click="" class="relative cursor-pointer  h-full">
            ...
            <div class="absolute z-20 bottom-0 w-full bg-blue-900 text-blue-100 px-2 py-1  flex flex-wrap justify-between w-full"><span>{{$theme->name}}</span> <button class="bg-green-800 hover:bg-green-100 text-green-100 hover:text-green-800 rounded-full px-2" wire:click="choose({{$theme->id}})">Choose</button></div>
        </div>
    </div>
    @endforeach
</div>